...
public class ActivityClass6 extends AppCompatActivity {
    ...
    List<ActivityQuestions6> actQueList;
    ActivityQuestions6 currentQ;

    private int questionCounter=0,questionTotalCount;

    private ActivityViewModel6 activityViewModel;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtQuestion = findViewById(R.id.displayQuestionscl6);
        textViewScore = findViewById(R.id.view_scorecl6);
        textViewQuestionCount = findViewById(R.id.number_of_questioncl6);
        textViewCountDownTimer = findViewById(R.id.timercl6);

        rbGroup = findViewById(R.id.radiogrpcl6);
        rb1 = findViewById(R.id.opt1cl6);
        rb2 = findViewById(R.id.opt2cl6);
        rb3 = findViewById(R.id.opt3cl6);
        rb4 = findViewById(R.id.opt4cl6);

        buttonNext = findViewById(R.id.buttonConfirmcl6);
        ...
        activityViewModel = ViewModelProviders.of(this).get(ActivityViewModel6.class);
        activityViewModel.getmAllQuestions().observe(this, new Observer<List<ActivityQuestions6>>() {
            @Override
            public void onChanged(List<ActivityQuestions6> activityQuestions) {
                Toast.makeText(ActivityClass6.this, "Let's Start", Toast.LENGTH_SHORT).show();
    ...
    private void getContent(List<ActivityQuestions6> questionsList) {
            ...
            public void onClick(View v) {
                ...
                if (!answered){
                    ...
                    if (rb1.isChecked() || rb2.isChecked() || rb3.isChecked() || rb4.isChecked()){
                        ...
                        Toast.makeText(ActivityClass6.this, "Please Select Answer", Toast.LENGTH_SHORT).show();
...
//    }
    ...
    private void DisplayDialogResult(){
        AlertDialog.Builder myBuilder = new AlertDialog.Builder(ActivityClass6.this);
        ...
        okay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(ActivityClass6.this, StartActivityClass.class));
            }
        });
