...
public class ActivityClass4 extends AppCompatActivity {
    ...
    List<ActivityQuestions4> actQueList;
    ActivityQuestions4 currentQ;

    private int questionCounter=0,questionTotalCount;

    private ActivityViewModel4 activityViewModel;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtQuestion = findViewById(R.id.displayQuestionscl4);
        textViewScore = findViewById(R.id.view_scorecl4);
        textViewQuestionCount = findViewById(R.id.number_of_questioncl4);
        textViewCountDownTimer = findViewById(R.id.timercl4);

        rbGroup = findViewById(R.id.radiogrpcl4);
        rb1 = findViewById(R.id.opt1cl4);
        rb2 = findViewById(R.id.opt2cl4);
        rb3 = findViewById(R.id.opt3cl4);
        rb4 = findViewById(R.id.opt4cl4);

        buttonNext = findViewById(R.id.buttonConfirmcl4);
        ...
        activityViewModel = ViewModelProviders.of(this).get(ActivityViewModel4.class);
        activityViewModel.getmAllQuestions().observe(this, new Observer<List<ActivityQuestions4>>() {
            @Override
            public void onChanged(List<ActivityQuestions4> activityQuestions) {
                Toast.makeText(ActivityClass4.this, "Let's Start", Toast.LENGTH_SHORT).show();
    ...
    private void getContent(List<ActivityQuestions4> questionsList) {
            ...
            public void onClick(View v) {
                ...
                if (!answered){
                    ...
                    if (rb1.isChecked() || rb2.isChecked() || rb3.isChecked() || rb4.isChecked()){
                        ...
                        Toast.makeText(ActivityClass4.this, "Please Select Answer", Toast.LENGTH_SHORT).show();
...
//    }
    ...
    private void DisplayDialogResult(){
        AlertDialog.Builder myBuilder = new AlertDialog.Builder(ActivityClass4.this);
        ...
        okay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(ActivityClass4.this, StartActivityClass.class));
            }
        });
