...
import com.example.elearningapplication.RecyclerView.RecyclerViewQ1;
...
//        });
    ...
    public void learningmodule(View view) {
        startActivity(new Intent(LearningMaterials.this, RecyclerViewQ1.class));
    }

    public void clickprofile(View view){
        startActivity(new Intent(LearningMaterials.this, Profile.class));
    }
}