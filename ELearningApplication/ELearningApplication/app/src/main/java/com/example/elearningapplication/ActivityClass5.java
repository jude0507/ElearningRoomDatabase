...
public class ActivityClass5 extends AppCompatActivity {
    ...
    List<ActivityQuestions5> actQueList;
    ActivityQuestions5 currentQ;

    private int questionCounter=0,questionTotalCount;

    private ActivityViewModel5 activityViewModel;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtQuestion = findViewById(R.id.displayQuestionscl5);
        textViewScore = findViewById(R.id.view_scorecl5);
        textViewQuestionCount = findViewById(R.id.number_of_questioncl5);
        textViewCountDownTimer = findViewById(R.id.timercl5);

        rbGroup = findViewById(R.id.radiogrpcl5);
        rb1 = findViewById(R.id.opt1cl5);
        rb2 = findViewById(R.id.opt2cl5);
        rb3 = findViewById(R.id.opt3cl5);
        rb4 = findViewById(R.id.opt4cl5);

        buttonNext = findViewById(R.id.buttonConfirmcl5);
        ...
        activityViewModel = ViewModelProviders.of(this).get(ActivityViewModel5.class);
        activityViewModel.getmAllQuestions().observe(this, new Observer<List<ActivityQuestions5>>() {
            @Override
            public void onChanged(List<ActivityQuestions5> activityQuestions) {
                Toast.makeText(ActivityClass5.this, "Let's Start", Toast.LENGTH_SHORT).show();
    ...
    private void getContent(List<ActivityQuestions5> questionsList) {
            ...
            public void onClick(View v) {
                ...
                if (!answered){
                    ...
                    if (rb1.isChecked() || rb2.isChecked() || rb3.isChecked() || rb4.isChecked()){
                        ...
                        Toast.makeText(ActivityClass5.this, "Please Select Answer", Toast.LENGTH_SHORT).show();
...
//    }
    ...
    private void DisplayDialogResult(){
        AlertDialog.Builder myBuilder = new AlertDialog.Builder(ActivityClass5.this);
        ...
        okay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(ActivityClass5.this, StartActivityClass.class));
            }
        });
