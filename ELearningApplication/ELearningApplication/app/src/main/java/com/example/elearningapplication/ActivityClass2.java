...
public class ActivityClass2 extends AppCompatActivity {
    ...
    List<ActivityQuestions2> actQueList;
    ActivityQuestions2 currentQ;

    private int questionCounter=0,questionTotalCount;

    private ActivityViewModel2 activityViewModel;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtQuestion = findViewById(R.id.displayQuestionscl2);
        textViewScore = findViewById(R.id.view_scorecl2);
        textViewQuestionCount = findViewById(R.id.number_of_questioncl2);
        textViewCountDownTimer = findViewById(R.id.timercl2);

        rbGroup = findViewById(R.id.radiogrpcl2);
        rb1 = findViewById(R.id.opt1cl2);
        rb2 = findViewById(R.id.opt2cl2);
        rb3 = findViewById(R.id.opt3cl2);
        rb4 = findViewById(R.id.opt4cl2);

        buttonNext = findViewById(R.id.buttonConfirmcl2);
        ...
        activityViewModel = ViewModelProviders.of(this).get(ActivityViewModel2.class);
        activityViewModel.getmAllQuestions().observe(this, new Observer<List<ActivityQuestions2>>() {
            @Override
            public void onChanged(List<ActivityQuestions2> activityQuestions) {
                Toast.makeText(ActivityClass2.this, "Let's Start", Toast.LENGTH_SHORT).show();
    ...
    private void getContent(List<ActivityQuestions2> questionsList) {
            ...
            public void onClick(View v) {
                ...
                if (!answered){
                    ...
                    if (rb1.isChecked() || rb2.isChecked() || rb3.isChecked() || rb4.isChecked()){
                        ...
                        Toast.makeText(ActivityClass2.this, "Please Select Answer", Toast.LENGTH_SHORT).show();
...
//    }
    ...
    private void DisplayDialogResult(){
        AlertDialog.Builder myBuilder = new AlertDialog.Builder(ActivityClass2.this);
        ...
        okay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(ActivityClass2.this, StartActivityClass.class));
            }
        });
